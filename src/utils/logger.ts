...
class Logger {
  ...
  public errorWithBanner(msg: string, err?: Error, ...args: LogExtraArgs) {
    this.error(
      ...
      '  https://github.com/IF-Lawrence/Orbit-Exporter/issues',
      ...args,
    );
  }

  public debug(...args: LogExtraArgs) {
    console.debug('[orbit-exporter]', ...args);
  }
